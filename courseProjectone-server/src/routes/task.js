...
router.patch('/tasks/:id', auth, async (req, res) => {
    ...
    try {
        ...
        task.description = 'First Change'
        // await task.save()    
        await delay
        // const taskAnother = await Task.findOne({ _id: req.params.id, owner: req.user.id });
        // taskAnother.description = 'Second Change'
        // return res.send(taskAnother)
        
        // updates.forEach((update) => task[update] = req.body[update]);
        await task.save();
        // await taskAnother.save()
...
router.patch('/tasksDuplicate/:id', auth, async (req, res) => {
    ...
    try {
        ...
        task.description = 'Duplicate Change'
        // await task.save()    
